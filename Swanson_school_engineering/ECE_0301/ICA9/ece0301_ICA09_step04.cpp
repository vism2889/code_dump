/*
	...
	DATE: 09/30/2020
 	FILENAME: ece0301_ICA09_step04.cpp
	DESCRIPTION:
...
class SortableArray
{
	...
	public:
		...
		void zeroFill();
		void displayOutput(ofstream &, bool sorted);
		void mergeArrays(double * addressPre, double * addressPost, unsigned int indexBLACKGREEN, unsigned int indexGRAYRED, unsigned int indexBLUE); 
};
...
int main()
{
	...
	sArr.mergeArrays(sArr.getStartPtr(), arr2.getStartPtr(), 2, 6, 11);
