...
int main(){
	...
	cout << "ECE 0301: Circuit Solver for Voltage Divider" << endl << "and Wheatstone bridge example curcuits." << endl;
	...
	if (firstLine == "Divider"){
		...
		lineOut << "ECE 0301: Circuit Solver for Voltage Divider" << endl << "and Wheatstone bridge example curcuits." << endl;
