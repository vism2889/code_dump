    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contact1Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RaspberryPi.this, MainActivity.class));
            }
        });
        ...
        contact2Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Raspberry_Pi")));
            }
        });
    }
